...
def add_arguments():
    ...
    parser.add_argument("--data_dir", dest = "data_dir", type=str, default='ISICdataNewAndLovely/jpeg/train/')#default on comp: ISICdataNewAndLovely/jpeg/train/
...
def main(args):
    ...
    if args.modeltype == "baseCase":
        ...
        model = flopCalcedModelBase.eval()
        ...
        timestart = time.time()
        model = flopCalcedModelLowKern.eval()
        summary(model, (3,224,224), max_depth=2)
        modelRunTime = time.time()-timestart   
