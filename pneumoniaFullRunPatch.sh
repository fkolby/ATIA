...
python ~/ATIAjbv/Pneumonia/chest_xray/pneumoniaATIApyfilemain.py --seed $SLURM_ARRAY_TASK_ID --modeltype Patch --max_epochs 50 --testSetName test --maxTime 10800 --gpu True --devices 1 --workers 10 --batchSize 64
