...
python ~/ATIAjbv/train/ATIApyfilemain.py --seed $SLURM_ARRAY_TASK_ID --modeltype 4x4 --max_epochs 100 --testSetName test --maxTime 10800 --gpu True --devices 1 --workers 10 --batchSize 64
